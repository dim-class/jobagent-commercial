...
有什么资格、正在补什么。问题可以有，但只是结尾的一小截，不是主角。
...
- **结尾不要「期待进一步沟通」「希望有机会进一步了解」。** 这两句等于没说。
  要么问一个 JD 里真没说清的短问题（不超过 15 字），要么就自然收住。
- **开头别每次都一样。** 用「您好」起头，但后面第一句最好落在这个岗位上，
  而不是千篇一律的「我目前从事……」。
