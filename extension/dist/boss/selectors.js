...
var BossSelectors = {
    ...
    GREETING_INPUT: ['textarea', '[contenteditable="true"]', '[contenteditable=""]'],
    ...
    FILTER_EXPERIENCE_BAND_RE: /^(不限|经验不限|在校生|应届生|在校\/应届|1年以内|\d{1,2}-\d{1,2}年|\d{1,2}年以[上内])$/,
